#
#  Be sure to run `pod spec lint Geniee-Wrapper-Ad-SDK-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Geniee-Wrapper-Ad-SDK-iOS"
  s.version      = "1.0.2"
  ...
  s.vendored_frameworks = "GNWrapperAdSdk/Framework/GNWrapperAdSdk.xcframework"
